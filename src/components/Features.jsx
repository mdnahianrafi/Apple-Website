...
const Features = () => {
  ...
  useGSAP(() => {
    ...
    gsap.to('.g_text', {
      ...
      scrollTrigger: {
        trigger: '.g_text',
        start: 'top 85%', // Ensures animation starts when the text enters viewport
          ...
          <div className="flex justify-center items-center flex-col sm:px-10">
            ...
            <div className="flex flex-col w-full relative">
              <div className="w-full flex justify-center items-center flex-col md:flex-row mt-10 md:mt-16 gap-5">
                ...
                <div className="overflow-hidden flex-1 h-[50vh]">
                  <img src={explore2Img} alt="titanium 2" className="w-full h-full object-cover object-center scale-150 opacity-0 g_grow" />
                </div>
              </div>
