...
import { models, sizes } from "../components/constants";
  ...
  return (
    <section className="common-padding">
      <div className="screen-max-width">
        <h1 id="heading" className="px-5 text-[#86868b] lg:text-6xl md:text-5xl text-3xl lg:mb-0 mb-5 font-medium opacity-0 translate-y-20">
          Take a closer look.
        </h1>
        ...
        <div className="flex flex-col items-center mt-5">
          ...
          <div className="mx-auto w-50">
            ...
            <div className="flex justify-center items-center">
              <ul className="flex items-center justify-center px-1 py-4 rounded-full bg-gray-700  backdrop-blur">
                {models.map((item, i) => (
